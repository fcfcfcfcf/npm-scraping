...
gulp.task("prettify-js", [], function() {
	return gulp.src("./src/js/asimplemde.js")
...
gulp.task("prettify-css", [], function() {
	return gulp.src("./src/css/asimplemde.css")
...
gulp.task("scripts", ["browserify:debug", "browserify", "lint"], function() {
	var js_files = ["./debug/asimplemde.js"];

	return gulp.src(js_files)
		.pipe(concat("asimplemde.min.js"))
		.pipe(uglify())
		.pipe(buffer())
		.pipe(header(banner, {pkg: pkg}))
		.pipe(gulp.dest("./dist/"));
...
gulp.task("styles", ["prettify-css"], function() {
	...
	return gulp.src(css_files)
		.pipe(concat("asimplemde.css"))
		.pipe(buffer())
		.pipe(header(banner, {pkg: pkg}))
		.pipe(gulp.dest("./debug/"))
		.pipe(minifycss())
		.pipe(rename("asimplemde.min.css"))
		.pipe(buffer())
		.pipe(header(banner, {pkg: pkg}))
		.pipe(gulp.dest("./dist/"));
});
