...
var createCoffee2Preprocessor = function (args, config, logger, helper) {
  config = config || {}

  var log = logger.create('preprocessor.coffee2')
  var defaultOptions = {
    bare: true,
    sourceMap: false
  }
...
createCoffee2Preprocessor.$inject = ['args', 'config.coffee2Preprocessor', 'logger', 'helper']

// PUBLISH DI MODULE
module.exports = {
  'preprocessor:coffee2': ['factory', createCoffee2Preprocessor]
}
